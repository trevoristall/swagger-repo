...
function setupBaseDir(options) {
  mainFile = options.basedir + "/" + mainFile;
  pathsDir = options.basedir + "/" + pathsDir;
  definitionsDir = options.basedir + "/" + definitionsDir;
  codeSamplesDir = options.basedir + "/" + codeSamplesDir;
}
